...
public class DateUtil {
	...
	public static LocalDateTime convertToLocalDateTime(Date date, Date time) {
		return LocalDateTime.of(DateUtil.convertDateToLocalDate(date), DateUtil.convertDateToLocalTime(time));
	}
